...
func (c *socialServiceClient) HomeFeed(ctx context.Context, in *HomeFeedRequest, opts ...grpc.CallOption) (*HomeFeedResponse, error) {
	out := new(HomeFeedResponse)
	err := c.cc.Invoke(ctx, "/SocialService/HomeFeed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSocialServiceServer) HomeFeed(context.Context, *HomeFeedRequest) (*HomeFeedResponse, error) {
...
func _SocialService_HomeFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HomeFeedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SocialServiceServer).HomeFeed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/SocialService/HomeFeed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SocialServiceServer).HomeFeed(ctx, req.(*HomeFeedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SocialService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HomeFeed",
			Handler:    _SocialService_HomeFeed_Handler,
		},
	},
